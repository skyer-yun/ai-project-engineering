...
> **版本**：v1.0 / 2026-06-30
> **用途**：B/B/Ship 节点出口 + 部署前快照 + 回滚
> **关联**：[01-标准层/03-质量门禁QG-D/S/B/Ship.md](../../01-标准层/03-质量门禁QG-D/S/B/Ship.md) §六 / [02-产物层/05-交付阶段/部署与验收文档模板.md](../../02-产物层/05-交付阶段/部署与验收文档模板.md)
...
|------|----------------|---------|
| **B 编码** | 推荐 | 每特性完成 → atomic commit 前 |
| **B 联调** | 推荐 | 集成测试通过后 → 提测前 |
| **Ship 部署** | **强制**（QG 部署门禁） | 生产部署前 → 必须 snapshot |
| Ship 验收 | 可选 | 客户验收后归档 |

详见 [01-标准层/03-质量门禁QG-D/S/B/Ship.md](../../01-标准层/03-质量门禁QG-D/S/B/Ship.md) §六。

---

## 与 HITL 集成

> Ship 部署 = L4 不可逆 → 强制 HITL-In（详见 [00-理论层/03-HITL模式与风险管理.md](../../00-理论层/03-HITL模式与风险管理.md) §四）
