...
| 技能包 | 用途 | 检测路径 | 状态 |
|--------|------|---------|------|
| architecture-designer | 架构设计（模式选择+模块划分+技术选型） | ~/.claude/skills/architecture-designer/skill.md | 已建 |
| detailed-designer | 详细设计（接口设计+数据模型+时序图） | ~/.claude/skills/detailed-designer/skill.md | 已建 |
