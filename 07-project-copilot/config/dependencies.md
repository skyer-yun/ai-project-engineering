...
| 04-dev-copilot | ~/.claude/skills/04-dev-copilot/skill.md | N8-N10 | 上游：接收源码+接口文档 |
| 05-testing-copilot | ~/.claude/skills/05-testing-copilot/skill.md | N11-N12 | 上游：接收测试报告 |
...
| 交接点 | 产物 | 检查文件 | 通过条件 |
|--------|------|---------|---------|
| QG1(N3→N4) | 需求确认书+技术方案 | 项目文档/售前/ | 文件存在+内容完整 |
| QG2(N7→N8) | PRD+Demo+设计规范 | 项目文档/产品/ | PRD已评审+Demo已确认 |
| QG3(N10→N11) | 源码+接口文档+联调报告 | 项目文档/开发/ | 代码冻结+联调通过 |
| QG4(N12→N13) | 测试报告+缺陷清单 | 项目文档/测试/ | P0/P1清零+报告Pass |
| QG5(N15→N16) | 交付文档包+验收报告 | 项目文档/交付/ | 验收签字+文档完整 |
